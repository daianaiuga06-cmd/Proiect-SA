//Numără de câte ori apare fiecare valoare în array.
//Folosește aceste numărători pentru a reconstrui array-ul sortat.
//Este eficient pentru numere întregi pozitive dintr-un interval restrâns.
//Complexitate: O(n + k), unde n = număr de elemente, k = valoarea maximă din array.
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
#include<time.h>
